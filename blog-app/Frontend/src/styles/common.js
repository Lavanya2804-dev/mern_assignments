...
export const navbarClass =
  "bg-white/80 backdrop-blur-2xl border-b border-[#e8e8ed] sticky top-0 z-50";

export const navContainerClass =
  "max-w-6xl mx-auto px-6 h-[64px] flex items-center justify-between";

export const navBrandClass =
  "text-xl font-semibold tracking-tight text-[#1d1d1f] hover:text-[#0066cc] transition-colors";

export const navLinksClass =
  "flex items-center gap-6";

export const navLinkClass =
  "text-sm text-[#6e6e73] hover:text-[#1d1d1f] transition-all duration-200 font-medium";

export const navLinkActiveClass =
  "text-sm text-[#0066cc] font-semibold";
